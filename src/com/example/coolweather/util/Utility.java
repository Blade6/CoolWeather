...
public class Utility {
	...
	public static void handleWeatherResponse(Context context, String response) {
		try {
			...
			if (status.equals("OK")) {
				...
				saveWeatherInfo(context, cityName, lastUpdate, weather_desp, temperature);
			}
	 ...
	 */
	public static void saveWeatherInfo(Context context, String cityName, String lastUpdate,
			String weather_desp, String temperature) {
